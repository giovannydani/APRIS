              ...
              <!-- form start -->
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <select id="inputJenisCiptaan" name="inputJenisCiptaan" class="form-control select2">
                        <option value="programkomputer">Program Komputer</option>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" id="inputUSC" name="inputUSC" rows="5"></textarea>
                    </div>
                  </div>
                  <div class="form-group row">
...
<script>
  $('#submit').click(function(){
    ...
    $.ajax({
        type: "POST",
        url: "<?= base_url() ?>user/hakcipta/addHakCipta",
        data:{
