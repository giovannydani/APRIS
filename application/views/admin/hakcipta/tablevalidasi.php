...
<script>
  ...
  $(document).ready(function(){
    hakcipta = $("#_hakcipta_").DataTable({
      ajax: {
        url: "<?php echo base_url()?>admin/hakcipta/tabledatavalidasi",
        type: "POST",
        dataSrc: "",
      },
      columns: [
        ...
        { data: "idHakCipta",
          render: function(data, type, row){
            return "\
              <a href='<?php echo site_url('admin/hakcipta/validasi/')?>"+data+"' data-toggle='tooltip' title='detail'>\
                  <button type='button' class='btn btn-warning'><i class='fa fa-check'></i> Validasi</button>\
              </a>\
              ";
          }
        }
